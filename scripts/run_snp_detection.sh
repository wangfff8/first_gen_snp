...
# 3. Replace `/path/to/your/final_assembly_dir` with the actual path to the directory
...
# python -m vsat.variant_caller -g <locus_name> -s /path/to/your/final_assembly_dir
